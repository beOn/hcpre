...
Take note that not all attributes are config-file-settable. Those that are not include those that are either derived at runtime. This list is undocumented at the moment, so you can either open the code or bug me about it.
